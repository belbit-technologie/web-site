        ...
        <nav className="bg-white shadow-lg fixed w-full top-0 left-0 z-50 transition-transform ease-in-out duration-300">
            <div className="container mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <div className="hidden lg:flex flex-grow items-center justify-center space-x-8">
                    ...
                    <Link to="/services" className="text-gray-800 hover:text-blue-600 transition-transform transform hover:scale-105">Services</Link>
                    ...
                    <div className="relative group">
                        ...
                        <div className="absolute hidden group-hover:block bg-white shadow-lg rounded-lg mt-2 z-50 w-64">
                            <Link to="#" className="flex items-center px-4 py-3 hover:bg-gray-100 transition duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3" viewBox="30 336.7 120.9 129.2" xmlSpace="preserve">
                            ...
                            <Link to="#" className="flex items-center px-4 py-3 hover:bg-gray-100 transition duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3" viewBox="0 0 384 512" fill="currentColor">
                ...
                <div className="hidden lg:flex items-center space-x-2">
                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-6 focus:ring-blue-300 font-medium rounded-full text-md px-5 py-2.5 text-center  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        login
                    </button>
                </div>
            ...
            >
                ...
                >
                    ...
                    <button type="button" className="text-white bg-blue-700  font-medium rounded-full text-md px-5 py-2.5 text-center " onClick={closeMenu}>
                        Login
                    </button>
