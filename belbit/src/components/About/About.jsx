    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="bg-gray-100 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-semibold text-center text-gray-800">Our Story</h2>
          <p className="mt-6 text-center text-lg text-gray-600">
            Founded in [Year], we have been leading the way in innovative solutions for companies worldwide.
            With a strong commitment to excellence and customer satisfaction, we take pride in our unique approach.
          </p>
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 bg-white rounded-lg shadow-lg">
              <h3 className="text-2xl font-semibold text-gray-800">Our Mission</h3>
              <p className="mt-4 text-gray-600">
                We aim to empower businesses by providing world-class services that fuel growth and efficiency.
              </p>
            </div>
            <div className="p-6 bg-white rounded-lg shadow-lg">
              <h3 className="text-2xl font-semibold text-gray-800">Our Vision</h3>
              <p className="mt-4 text-gray-600">
                To be the global leader in providing innovative solutions that transform businesses for the future.
              </p>
            </div>
            <div className="p-6 bg-white rounded-lg shadow-lg">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-semibold text-center text-gray-800">Meet Our Team</h2>
      ...
      <section className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-semibold text-white">Ready to Learn Driving?</h2>
          <p className="mt-4 text-lg text-gray-200">
            Let’s take your business to the next level with our innovative solutions.
          </p>
          <div className="flex justify-center mt-6 space-x-4">
          <button className="flex items-center bg-black text-white px-4 py-2 rounded-lg shadow-lg">
            {/* Google Play SVG */}
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2" viewBox="30 336.7 120.9 129.2" xmlSpace="preserve">
              ...
              <path fill="#00FF00" d="M99.1 376.7L41.1 414.6v27.6c-.5.1-1.1 0-1.6-.1l.7 11c.9-.2 2.1-.3 3-.3L99.1 376.7z"/>
              <path fill="#0000FF" d="M99.1 410.6v-11.7L67.9 394.5l31.2-16.7v-11.7l-31.2 16.7 31.2 16.7z"/>
            </svg>
          ...
          <button className="flex items-center bg-black text-white px-4 py-2 rounded-lg shadow-lg">
            {/* App Store SVG */}
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2" viewBox="0 0 384 512" fill="currentColor">
